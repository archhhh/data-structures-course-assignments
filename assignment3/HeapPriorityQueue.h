...
template<typename E, typename C>
HeapPriorityQueue<E,C>::HeapPriorityQueue(const HeapPriorityQueue&q):T(q), isLess(){
}
template<typename E, typename C>
...
template<typename E, typename C>
Position HeapPriorityQueue<E,C>:: insert(const E&e){
  T.addLast(e);
  bubbleUp(T.last());
}
template<typename E, typename C>
...
template<typename E, typename C>
Position HeapPriorityQueue<E,C>::replace(const Position &p, const E& e){
  if(e < *p)
  {
    *p = e;
    bubbleUp(p);
